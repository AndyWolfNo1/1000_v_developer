...
##        nr = input('Podaj nr koloru karty i nr karty (po przecinku) którą chcesz oddać pierwszemu przeciwnikowi\n')
##        nr = nr.split(',')
##        nr2 = input('Wybierz kartę którą chcesz dać swojemu wspólnikowi\n')
##        nr2 = nr2.split(',')
##        nr3 = input('Wybierz kartę którą chcesz dać 2 przeciwnikowi\n')
##        nr3 = nr3.split(',')
##        cards = []
##        cards.append(self.cards[int(nr[0])][int(nr[1])])
##        cards.append(self.cards[int(nr2[0])][int(nr2[1])])
##        cards.append(self.cards[int(nr3[0])][int(nr3[1])])
##        print(cards)
